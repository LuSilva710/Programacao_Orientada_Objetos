/*
 * Escreva uma classe Continente. Um continente possui um nome
* e é composto por um conjunto de países. Forneça os membros de classe a seguir:
 ...
 */
package listapoo_ex07;

import java.util.ArrayList;

public class Continente {
    private String nome;
     private ArrayList<Continente> conjuntoPaises;

    public Continente(String novoNome) {
       this.nome = novoNome;
    }
    
    public void adicionarPaises(Continente novoPais){
         if (!this.conjuntoPaises.contains(novoPais)) {
        this.conjuntoPaises.add(novoPais);
    }
}
